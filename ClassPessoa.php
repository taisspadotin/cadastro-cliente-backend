...
class ClassPessoa extends ClassConexao{
    ...
    public function cadastroPessoa($nome, $telefone, $cpf, $rg, $nascimento, $endereco)
    {
        $resposta = '';
    ...
    public function buscaPessoa($page, $limit){
        if(empty($page)){
            $page = 0;
        }
        if(empty($limit)){
    ...
    public function alteraPessoa($id, $nome, $telefone, $cpf, $rg, $nascimento, $endereco){
        $id             = !empty($id) ? $id: '';
